...
//    '{attribute} can contain only letters, numbers, and "_"' => '',
    ...
    'USER_POINTS' => 'У вас <span class="required">{0}</span> бонусов',
    'BONUS_ACTIVATED' => 'Вы успешно применили <strong>{0}</strong> бонусов',
    'BONUS_ACTIVE' => 'Активировано <strong>{0}</strong> бонусов',
    'BONUS_NOT_ENOUGH' => 'У Вас недостаточно бонусов',
    'BONUS_CANCELED' => 'Вы отменили бонусы',
    'BONUS_POINTS' => 'Бонусных Баллов',
    'BONUS_INFO' => 'Бонусные балы вам начисляются после каждой покупки.',
    'BONUS_EXPIRE' => 'Действительны до',
];
