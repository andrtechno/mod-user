...
class SettingsForm extends SettingsModel
{
    ...
    {
        $labels = [];
        if (isset(Yii::$app->currency)) {
            $labels['bonus_ratio'] = self::t('BONUS_RATIO', ['currency' => Yii::$app->currency->main['symbol']]);
        }
        return ArrayHelper::merge(parent::attributeLabels(), $labels); // TODO: Change the autogenerated stub
    }
