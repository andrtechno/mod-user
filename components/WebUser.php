...
use panix\mod\admin\components\TimelineEvent;
...
class WebUser extends User
{
    ...
    public function beforeLogin($identity, $cookieBased, $duration)
    {
        ...
        $event->params = ['id' => $identity->id];
        $event->callback = 'onLogin';
        Timeline::add($event, ['user_id' => $identity->id]);
